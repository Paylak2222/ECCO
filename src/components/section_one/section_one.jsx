        ...
        <div className={styles.sectionsContainer}>
          <div className={styles.sectionOne}>
            ...
            <p className={styles.descriptionOne}>
              ...
              cannabis. The current standards for cannabis safety are often not
              met or are inconsistent.
            </p>
          </div>
          <div className={styles.sectionTwo}>
            ...
            <p className={styles.descriptionTwo}>
              ...
              determine compliance and adherence to our safety, quality, and
              environmental standards. Our brands carry the ECCO mark at retail,
              allowing customers to make clear choices that benefit their
