    ...
    <div className="container">
      <section className={style.about_section}>
        ...
        <div className={style.sec_about}>
          ...
          <span>
            ECCO is a nonprofit, voluntary certification for cannabis products.
             We test our member products for over 100+ contaminants and evaluate
            and raise environmental and ethical standards in consumer cannabis.
          </span>
        </div>
        <div className={style.about_div}>
