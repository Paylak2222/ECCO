...
const questions = [
    {
        ...
        answer: "ECCO is a non-profit organization that provides a certification program for cannabis brands that are committed to using sustainable and regenerative practices. ECCO is dedicated to promoting the highest standards of environmental and social responsibility in the cannabis industry."
    },
    {
        question: "What are the benefits of becoming ECCO certified?",
        answer: "ECCO certification provides cannabis brands with a competitive advantage by demonstrating their commitment to sustainability and social responsibility. ECCO certified brands are recognized for their environmental stewardship and ethical business practices, which can help attract environmentally conscious consumers and investors."
    },
    {
        question: "How can I become ECCO certified?",
        answer: "To become ECCO certified, cannabis brands must meet the organization's rigorous standards for sustainable and regenerative practices. Brands must undergo a thorough assessment of their operations and supply chain to ensure compliance with ECCO's certification requirements. Once certified, brands can display the ECCO seal on their products to showcase their commitment to sustainability."
    },
    {
